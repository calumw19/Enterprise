...
if(isset($_POST['registerbtn']))
{
    ...
    else
    {
        ...
        {
            $query = "INSERT INTO user (username,email,password) VALUES ('$email','$email','$password')";
...
if(isset($_POST['update_dark']))
{
    ...
    $query = "UPDATE user SET dark='$dark' WHERE id='$id' ";
    $query_run = mysqli_query($connection, $query);
...
if(isset($_POST['update_food']))
{
    ...
    $query = "UPDATE user SET food='$food' WHERE id='$id' ";
    $query_run = mysqli_query($connection, $query);
